                    ...
                    >
                        ...
                        <div className="sm:hidden flex flex-col gap-2 mb-2 pb-2 border-b border-slate-100 dark:border-zinc-800">
                            <Link
                                    ...
                                    >
                                        <span>{t('dashboard.btnKnowledgeBase')}</span>
                                    </Link>
                            {(isAdmin || isSuperAdmin) && (
                                <Link
                                    href="/clients"
                        ...
                        {isSuperAdmin && (
                            <>
                                ...
                                >
                                    {t('common.navAdminData')}
                                </Link>
                                <Link
                                    href="/admin/audit"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                    className="text-left text-[15px] font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-colors px-3 py-2.5 rounded-lg block"
                                >
                                    {t('common.navAdminAudit')}
                                </Link>
                                <Link
                                    href="/settings"
                                    onClick={() => setIsMobileMenuOpen(false)}
