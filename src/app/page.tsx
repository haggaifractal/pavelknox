...
import { 
    ...
    Edit3, Trash2, Mic, Bot, Calendar, Clock, Lock, RefreshCcw, Loader2
} from 'lucide-react';
                ...
                <main className="max-w-[1600px] w-full mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <header className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-20">
                        ...
                        >
                            ...
                            >
                                <Database className="w-4 h-4 rtl:ml-2 ltr:mr-2 opacity-70" aria-hidden="true" />
                                {t('dashboard.btnKnowledgeBase')}
                            </button>
                            
                            <button
                                onClick={() => refresh()}
                                className="inline-flex items-center h-10 px-4 border border-slate-200 dark:border-zinc-800 text-[13px] font-semibold rounded-xl text-slate-700 dark:text-zinc-300 bg-white dark:bg-zinc-900/50 hover:bg-slate-50 dark:hover:bg-zinc-800 shadow-sm transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 w-full sm:w-auto"
                            >
                                <RefreshCcw className="w-4 h-4 rtl:ml-2 ltr:mr-2 opacity-70" aria-hidden="true" />
                                {t('common.refresh') || 'Refresh'}
                            </button>
                            
                            <div className="h-10 px-4 inline-flex items-center justify-center border border-indigo-200 dark:border-indigo-500/20 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 rounded-xl text-[13px] font-bold shadow-sm w-full sm:w-auto" aria-live="polite">
                    ...
                    {/* Filters */}
                    <div className="flex flex-col gap-6 relative z-10 w-full mb-6">
                        <DashboardFilters 
                            status={filterStatus}
                                                    ...
                                                    {isExpanded && (
                                                        ...
                                                        >
                                                            <div className="p-6 lg:rtl:pl-8 lg:rtl:pr-24 lg:ltr:pr-8 lg:ltr:pl-24 grid grid-cols-1 lg:grid-cols-2 gap-8">
                                                                ...
                                                                {/* Full Text View */}
                                                                <div>
                                                                    <details className="group [&_summary::-webkit-details-marker]:hidden overflow-hidden">
                                                                        <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-xl border border-slate-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-950/50 p-4 text-slate-900 dark:text-white font-medium hover:bg-slate-50 dark:hover:bg-zinc-900 transition-colors shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-indigo-500">
                                                                            <h5 className="text-[12px] font-bold uppercase tracking-widest text-slate-500 dark:text-zinc-400 flex items-center gap-2">
                                                                                <FileText className="w-3.5 h-3.5" aria-hidden="true" /> {t('dashboard.expandedSourceTitle')}
                                                                            </h5>
                                                                            <span className="shrink-0 transition duration-300 group-open:-rotate-180">
                                                                                <ChevronDown className="h-4 w-4 text-slate-400 dark:text-zinc-500" aria-hidden="true" />
                                                                            </span>
                                                                        </summary>

                                                                        <div className="mt-3 bg-white dark:bg-zinc-950/50 p-4 rounded-xl border border-slate-200 dark:border-zinc-800/80 prose prose-sm dark:prose-invert max-w-none shadow-inner custom-scrollbar text-[13px] leading-relaxed text-slate-600 dark:text-zinc-300 max-h-[400px] overflow-y-auto">
